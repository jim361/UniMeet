...
export default function HomeScreen() {
  ...
  const handleConfirmCreate = () => {
    ...
    const successMsg = `[${newClubName}] 동아리가 성공적으로 생성되었습니다!`;
    if (Platform.OS === 'web') {
          ...
          <View style={styles.modalContent}>
            ...
            <View style={styles.modalBtnRow}>
              ...
              <TouchableOpacity style={styles.saveBtn} onPress={handleConfirmCreate}>
                <Text style={styles.saveBtnText}>개설하기</Text>
              </TouchableOpacity>
            </View>
          </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  card: { backgroundColor: '#ffffff', borderRadius: 16, padding: 18, borderWidth: 1, borderColor: '#f0f3f6', flexDirection: 'row', alignItems: 'center' },
  ...
  cardTitle: { fontSize: 16, fontWeight: 'bold', color: '#1a2d42' },
  cardSubtitle: { fontSize: 13, color: '#8a9aa8', marginTop: 2 },
  modalOverlay: { flex: 1, backgroundColor: 'rgba(0,0,0,0.5)', justifyContent: 'center', alignItems: 'center' },
  modalContent: { backgroundColor: '#fff', width: '85%', borderRadius: 20, padding: 24 },
  modalTitle: { fontSize: 18, fontWeight: 'bold', marginBottom: 16, textAlign: 'center' },
  input: { backgroundColor: '#f4f6f9', padding: 12, borderRadius: 10, marginBottom: 12 },
